...
>
  {/* Header */}
  <div className="flex justify-between items-center px-4 pt-4 text-white w-[68%] md:w-[60vw] md:ml-[20vw]">
    <Link href="/">
  ...
  {/* Device Labels */}
  <div className="flex justify-between px-4 mt-3 text-white md:ml-[20vw]">
    <span className=" font-light text-2xl">Watch Movie</span>
  </div>

  {/* Turn on / Home */}
  <div className="flex gap-8 px-16 mt-10 ml-4 md:ml-[16vw]">
  ...
  {/* Back + Menu */}
  <Link href="/theatre/watch" className="">
   <div className="flex  px-8 mt-84 w-[90%] h-30 rounded-[6px] bg-gray-500/90 ml-[5%] items-center gap-12 md:w-[60vw] md:ml-[20vw] md:mt-40">
